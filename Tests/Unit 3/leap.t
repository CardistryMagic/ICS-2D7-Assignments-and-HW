...
body procedure findLeapYears
    ...
    addFactor := years (1) - 1
    var allYears : array 1 .. years (2) - years (1) + 1 of int
    put "All leap years between Year ", years (1) + 1, " and ", years (2), " is/are:"
    for testCurrentYear : 1 .. years (2) - years (1) + 1 by 1
    ...
    for checkCurrentYearInArray : 1 .. years (2) - years (1) + 1 by 1
