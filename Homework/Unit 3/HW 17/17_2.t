...
function smallest (numbersForFunction : array 1 .. * of real, numberOfRepeats : int) : real
...
loop
	...
	exit when temporaryVariable = "quit" or temporaryVariable = "quit quit"
	new numbers, count
	numbers (count) := strreal (temporaryVariable)
    end loop
    put "The smallest number is ", smallest (numbers, count), " ."
    put " "
